...
namespace Risecommerce\HtmlSitemap\Block\Catalog;
...
{
    const XML_PATH_TO_CATALOG_CATEGORY_BLOCK_TITLE = 'rchs/categorylinks/title';
    const XML_PATH_TO_CATALOG_CATEGORY_DEPTH = 'rchs/categorylinks/maxdepth';
    const XML_PATH_TO_CATALOG_CATEGORY_VIEW_MORE = 'rchs/categorylinks/displaymore';
    const XML_PATH_TO_CATALOG_CATEGORY_LIMIT = 'rchs/categorylinks/maxnumberlinks';
    ...
    private function getExcludedCategoriesIds()
    {
        if (!$this->excludedCategoriesIds) {
            $this->excludedCategoriesIds = $this->collectionFactory->create()
                ->addAttributeToFilter('rc_exclude_html_sitemap', 1)->getAllIds();
        }
