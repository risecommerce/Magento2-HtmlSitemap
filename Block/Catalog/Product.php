...
{
    const XML_PATH_TO_CATALOG_CATEGORY_BLOCK_TITLE = 'rchs/productlinks/title';
    const XML_PATH_TO_CATALOG_PRODUCTS_LIMIT = 'rchs/productlinks/maxnumberlinks';
    const XML_PATH_TO_CATALOG_PRODUCT_VIEW_MORE = 'rchs/categorylinks/displaymore';
