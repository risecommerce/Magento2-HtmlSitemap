...
namespace Risecommerce\HtmlSitemap\Block\Additional;
...
{
    const XML_PATH_TO_ADDITIONAL_BLOCK_TITLE = 'rchs/additionallinks/title';
    const XML_PATH_TO_ADDITIONAL_LINKS = 'rchs/additionallinks/links';
    const XML_PATH_TO_ADDITIONAL_LINKS_LIMIT = 'rchs/additionallinks/maxnumberlinks';
    const XML_PATH_TO_ADDITIONAL_LINKS_MORE = 'rchs/additionallinks/displaymore';
